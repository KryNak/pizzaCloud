...
public class DevelopmentConfig {
    ...
    public CommandLineRunner dataLoader(UserRepository userRepo, IngredientRepository ingredientRepo,
                                        OrderRepository orderRepo, PizzaRepository pizzaRepo) {
        return args -> {

            User sa = new User("sa", "12345", "Michal Blat",
            ...
            List<Pizza> pizzas = Arrays.asList(
                    new Pizza(2L, new Date(), "Margarita", Lists.newArrayList(ingredientRepo.findAllById(Arrays.asList("TNPD", "KECH", "GOUD", "CHED")))),
                    new Pizza(3L, new Date(), "Salami", Lists.newArrayList(ingredientRepo.findAllById(Arrays.asList("TNPD", "SALS", "GOUD", "CHED", "TMTO")))),
                    new Pizza(4L, new Date(), "Premium", Lists.newArrayList(ingredientRepo.findAllById(Arrays.asList("TKPD", "KECH", "CHED", "CUCH", "MIBF"))))
            );
